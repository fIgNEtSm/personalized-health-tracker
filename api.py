...
@api_app.route('/users/<int:user_id>/', methods=['GET'])
...
@api_app.route('/users/', methods=['POST'])
def add_user():
...
@api_app.route('/users/<int:user_id>/', methods=['PUT'])
...
@api_app.route('/users/<int:user_id>/', methods=['DELETE'])
...
@api_app.route('/foodlog/<int:user_id>/', methods=['GET'])
...
@api_app.route('/foodlog', methods=['POST'])
def add_food_log():
    data = request.get_json()
...
@api_app.route('/healthlog', methods=['POST'])
def add_health_log():
    data = request.get_json()
    new_log = HealthLog(
...
@api_app.route('/healthscore/<int:user_id>', methods=['GET'])
...
@api_app.route('/streak/<int:user_id>', methods=['GET'])
